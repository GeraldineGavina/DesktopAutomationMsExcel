...
Windows.setText(findWindowsObject('C2'), '5')

Windows.click(findWindowsObject('C3'))

Windows.setText(findWindowsObject('C3'), '5')

Windows.click(findWindowsObject('C4'))

Windows.setText(findWindowsObject('C4'), '5')

Windows.click(findWindowsObject('D5'))

Windows.setText(findWindowsObject('D5'), '=SUM(C2:C4)')
